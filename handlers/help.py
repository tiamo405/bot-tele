...
def register_handlers(bot):
    ...
    def handle_help(message):
        ...
        help_text = (
            ...
            "🚔 **/phatnguoi** or **/pn** - Tra cứu phạt nguội, thêm/xóa xe đăng ký\n"
            "🚗 **/pn biển-số** - Tra cứu nhanh theo biển số (hỗ trợ thêm `car/moto`)\n\n"
            "💰 **/vang** hoặc **/giavang** - Xem giá vàng + so sánh tỷ giá bank/chợ đen\n"
            ...
            "🚔 **PHẠT NGUỘI:**\n"
            "• Mở menu: `/pn` hoặc `/phatnguoi`\n"
            "• Tra cứu nhanh: `/pn 30A-123.45`\n"
            "• Chỉ định loại xe: `/pn 30A-123.45 car`\n"
